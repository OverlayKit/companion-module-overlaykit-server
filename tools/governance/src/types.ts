...
export const GITHUB_EVIDENCE_SCHEMA_VERSION = 'overlaykit-governance-github-evidence/v1' as const;
...
export type MechanismKind =
  'local-command' | 'github-actions-job' | 'github-ruleset' | 'human-review';
